...
class SharedPen {
  constructor (cm, url) {
    ...
    socket.on('doc', (data) => {  //注册客户端doc事件，一连接服务器端就触发了这个事件emit('doc')
      ...
      // 富文本的文本属性变化会触发sharepen的realtimeTextAttrsChanged，从而触发在app.js里用on为sharepen的realtimeTextAttrsChanged绑定的函数
